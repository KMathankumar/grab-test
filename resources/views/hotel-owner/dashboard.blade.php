                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100 shadow-sm" style="border-left:4px solid #1E88E5;">
                        <div class="card-body">
                            ...
                            <small class="text-muted">Total: ₹{{ number_format($stats['total_revenue'] ?? 0, 2) }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-start">
                                                ...
                                                <div>
                                                    <span class="badge" style="background: {{ $item->is_available ? '#1BAD40' : '#6c757d' }}; color:#fff;">{{ $item->is_available ? 'Available' : 'Unavailable' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column gap-2">
                            <a href="{{ route('hotel-owner.food-items.create') }}" class="btn btn-danger">+ Add Food Item</a>
                            <a href="{{ route('hotel-owner.food-items.index') }}" class="btn btn-outline-secondary">Manage Menu</a>
                            <a href="#" class="btn btn-outline-secondary">View Orders</a>
                            <a href="{{ \Illuminate\Support\Facades\Route::has('hotel-owner.earnings.index') ? route('hotel-owner.earnings.index') : '#' }}" class="btn btn-outline-secondary">Withdrawals</a>
                        </div>
                    </div>
                </div>
            </div>
